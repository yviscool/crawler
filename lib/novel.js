...
var { downloadNovel } = require('./pipe');
...
module.exports.getNovel = function () {
    ...
    function verifyErrorOrThrowError(e) {
        ...
        if (e.message.length <= 3) { return RL.question(PROMPTS.download) };
...
class Biquge extends Novel {
    ...
    getChapterUrl(flag) {
        ...
        function __parse({ body, res }) {
            ...
            return {
                chapterUrls,
                novelName: novelName || '未命名',
                source: self.novelMap.source,
            }
